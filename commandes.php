        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <button  class="btn btn-outline-danger" data-bs-toggle="modal" <?php if(in_array($ligne['idcommande'],$list)){ echo "disabled";}?> data-bs-target="#deleteModal<?php echo $count ?>" >
